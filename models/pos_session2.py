...
class PosSession(models.Model):
    ...
    def _loader_params_hr_employee(self):
        ...
        print({'search_params': {'domain': domain, 'fields': ['name', 'id', 'user_id'], 'load': False}})
        return {'search_params': {'domain': domain, 'fields': ['name', 'id', 'user_id'], 'load': False}}

    def _get_pos_ui_hr_employee(self, params):
        print('called _get_pos_ui_hr_employee')
        ...
        employees_data = self.sudo().search_read([('id', 'in', visible_emp_ids.ids)], ['employee_ln_address', 'employee_ln_qr_image'])
        ...
        for employee in employees:
            ...
            employee['employee_ln_address'] = employees_data[employee['id']]['employee_ln_address']
            employee['employee_ln_qr_image'] = employees_data[employee['id']]['employee_ln_qr_image']
